# pages/retailgift.py – JOUW SCRIPT + LOCATION POTENTIAL 2.0 (100% WERKENDE VERSIE – 25 nov 2025)
...
if tool == "Store Manager" and len(selected) == 1:
    ...
    st.info("Store Manager view nog niet aangepast – werkt zoals voorheen")
...
# --- REGIO MANAGER VIEW + LOCATION POTENTIAL 2.0 ---
    ...
    st.success(f"**Totaal onbenut potentieel deze maand: €{int(pot_df['Gap €'].sum()):,}**")

else:
    st.header("Directie view – binnenkort beschikbaar")

st.caption("RetailGift AI – Location Potential 2.0 LIVE – 25 nov 2025")
